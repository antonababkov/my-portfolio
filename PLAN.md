...
| 13  | **Тестирование**             | Кроссбраузерность, Lighthouse, a11y                           | ✅ Выполнен (02.09.2026): focus trap + restore в модалке, skip-link, ароматическая a11y, контраст AA, Autoprefixer-префиксы подтверждены в сборке, тема-переключатель/слайдер (свайп+клавиатура). Lighthouse-прогон — вручную (требует браузер/DevTools) |
